...
function Search() {
    let txtSearchName = document.getElementById("search").value;
    let txtSearchId = document.getElementById("id").value
...
function searchByName() {
    ...
    fetch(`http://localhost:8080/employee/Employee-search-by-name/${searchName}`, requestOptions)
        .then((response) => response.json())
        .then((result) => {
            console.log(result);
            document.getElementById("id").value = result.id;
